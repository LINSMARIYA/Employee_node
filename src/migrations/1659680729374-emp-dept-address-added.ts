...
export class empDeptAddressAdded1659680729374 implements MigrationInterface {
    name = 'empDeptAddressAdded1659680729374'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "employee" ("created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP, "id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying NOT NULL, "username" character varying NOT NULL, "role" character varying NOT NULL, "status" character varying NOT NULL, "experience" double precision NOT NULL, "date_of_joining" character varying NOT NULL, "password" character varying NOT NULL DEFAULT 'password', "department_id" uuid NOT NULL, "address_id" uuid NOT NULL, CONSTRAINT "REL_2a4f5082f1be346e2b8cdec219" UNIQUE ("address_id"), CONSTRAINT "PK_3c2bc72f03fd5abbbc5ac169498" PRIMARY KEY ("id"))`);
