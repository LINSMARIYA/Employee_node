...
class EmployeeController extends controller_1.AbstractController {
    ...
    initializeRoutes() {
        ...
        this.router.get(`${this.path}/:id`, (0, authorize_1.default)(["admin"]), (0, authorize_1.default)([constants_1.USER_ROLES.admin, constants_1.USER_ROLES.manager]), (0, validationMiddleware_1.default)(GetEmployeeDto_1.GetEmployeeDto, constants_1.default.params), this.getEmployeeById);
