...
class EmployeeController extends controller_1.AbstractController {
    ...
    initializeRoutes() {
        ...
        this.router.put(`${this.path}/:id`, (0, validationMiddleware_1.default)(IdDto_1.IdDto, constants_1.default.params), (0, validationMiddleware_1.default)(UpdateEmployeeDto_1.UpdateEmployeeDto, constants_1.default.body), this.updateEmployeeById);
